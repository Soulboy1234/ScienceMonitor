...
- `hierarchical_tag_reference.md` 是人工参考，不是运行时模板，因此保留在 `docs/workflow_specs/`
...
- 如果涉及报告生成后的格式修复、审核和失败条件，先看 `report_review_rules.md`
- 像 `literature_codex_quick_guide.md`、`deep_reading_comparison_and_fusion.md` 这类主要供人阅读的材料，应放到 `docs/user_guides/`
- 说明文件的放置规则由 `src/sciencemonitor/docs_review.py` 审核
