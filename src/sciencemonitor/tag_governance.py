...
EXISTING_OUTPUT_TAG_ALIAS_MAP = {
    ...
    "事件/HILDCAA": ["事件/HILDCAAs"],
    "HILDCAA": ["事件/HILDCAAs"],
    "事件/SC": ["事件/磁暴/急始"],
    "SC": ["事件/磁暴/急始"],
    "事件/行星际扰动": ["对象/行星际环境"],
    "事件/极光电喷流/AE指数": ["对象/极区/极光电集流", "指数/AE"],
    ...
    "模型/深度学习": ["方法/建模/机器学习"],
    "模型/残差网络": ["方法/建模/机器学习"],
    "方法/物理信息神经网络": ["方法/建模/机器学习/PINN"],
    "方法/物理约束神经网络": ["方法/建模/机器学习/PINN"],
    "方法/PINN": ["方法/建模/机器学习/PINN"],
    "方法/PINNs": ["方法/建模/机器学习/PINN"],
    "方法/可解释性人工智能": ["方法/可解释模型/XAI"],
    "方法/可解释人工智能": ["方法/可解释模型/XAI"],
    "方法/XAI": ["方法/可解释模型/XAI"],
    "方法/机器学习/人工神经网络": ["方法/建模/机器学习"],
    "方法/模拟": ["方法/数值模拟"],
    "方法/评估指标": ["方法/误差估计"],
    "方法/数据同算/IRIDEA": ["方法/数据同化"],
    "对象/统计分析": ["方法/统计研究"],
    "对象/计算机模拟": ["方法/数值模拟"],
    "对象/神经网络": ["方法/建模/机器学习"],
    "对象/人工神经网络": ["方法/建模/机器学习"],
    "对象/数据科学": ["方法/建模/机器学习"],
    "对象/中层大气": ["对象/中间层"],
    "对象/低纬度电离层": ["对象/电离层/低纬"],
    "对象/F层": ["对象/电离层"],
    "对象/电离层/F层": ["对象/电离层"],
    "对象/电离层/F2层": ["对象/电离层"],
    "对象/电离层/F层峰高": ["对象/电离层/hmF2"],
    "对象/电离层/F2层峰高": ["对象/电离层/hmF2"],
    "对象/全球平均TEC": ["对象/电离层/TEC"],
    "对象/EUV加热": ["指数/EUV"],
    "对象/中性温度": ["对象/热层/温度"],
    "对象/热层/水平风": ["对象/热层/风场"],
    "对象/热层/一氧化氮": ["对象/热层/成分"],
    "对象/中纬度低层热层": ["对象/热层/低热层"],
    "对象/二维模型": ["方法/数值模拟"],
    "对象/大气波": ["对象/重力波", "对象/潮汐"],
    "对象/极光电子沉形成": ["对象/电子沉降"],
    "对象/气动力学阻力": ["应用/卫星影响"],
    "对象/电网": ["应用/基础设施"],
    "对象/电流/极地电喷流": ["对象/极区/PEJ"],
    "对象/电离层电导率": ["对象/电离层"],
    "对象/磁场/行星际磁场": ["指数/IMF"],
    "对象/航空": ["应用/空间天气影响"],
    "对象/Swarm卫星": ["仪器/Swarm"],
    ...
    "仪器/ENSO": ["事件/ENSO"],
    "仪器/全天相机": ["仪器/全天空相机"],
    "仪器/Digisonde": ["仪器/电离层测高仪"],
    "仪器/不相干散射雷达": ["仪器/ISR"],
    "对象/行星际磁场": ["指数/IMF"],
    "对象/磁场/IMFBy": ["指数/IMF/By"],
    "对象/磁场/IMFB_y": ["指数/IMF/By"],
    "对象/IMFB_y": ["指数/IMF/By"],
    "指数/IMF_By": ["指数/IMF/By"],
    "对象/磁层/IMFBz": ["指数/IMF/Bz"],
    "对象/磁场/IMFB_z": ["指数/IMF/Bz"],
    "对象/IMFB_z": ["指数/IMF/Bz"],
    "指数/IMF_Bz": ["指数/IMF/Bz"],
    "对象/金星/感应磁层": ["对象/其他行星/金星"],
    "对象/水星/磁尾": ["对象/其他行星/水星"],
    "对象/磁尾/O+": ["对象/重离子"],
    "对象/磁尾/O2+": ["对象/重离子"],
    "对象/高能粒子/相对论性电子": ["对象/相对论电子"],
    "对象/OMNI数据": ["仪器/OMNI"],
    "模型/TIE-GCM": ["模型/TIEGCM"],
    "仪器/TIE-GCM": ["模型/TIEGCM"],
    "模型/TIEGCO": ["模型/TIEGCM"],
    "模型/NRLMSIS": ["模型/NRLMSISE-00"],
    "模型/SD-WACCMX": ["模型/WACCM-X"],
    "模型/Weimer电势模型": ["模型/Weimer"],
    "方法/数值模拟/SD-WACCMX": ["模型/WACCM-X"],
    "方法/建模/误差传播": ["方法/误差估计"],
    "方法/文献综introspective": ["综述"],
    "仪器/THEMIS": ["仪器/THEMIS_A-E"],
    "仪器/thEMiS": ["仪器/THEMIS_A-E"],
    "仪器/地面磁力计": ["仪器/磁强计"],
    "仪器/ACE卫星": ["仪器/ACE"],
    "仪器/GRACEA": ["仪器/GRACE"],
...
PENDING_DIRECT_REWRITE_MAP = {
    ...
    "对象/磁尾/O2+": "对象/重离子",
    "对象/高能粒子/相对论性电子": "对象/相对论电子",
    "方法/E-CHAIM": "模型/E-CHAIM",
    "仪器/E-CHAIM": "模型/E-CHAIM",
}
